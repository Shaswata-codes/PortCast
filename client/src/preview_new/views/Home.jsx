        ...
        <section className="pt-2">
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              {/* Right Column: Live Maritime Intelligence Hub Card */}
                ...
                <div className={`p-6 sm:p-7 rounded-3xl ${glassCard} border border-white/95 shadow-2xl relative overflow-hidden space-y-5 bg-white/90 backdrop-blur-2xl`}>
                  ...
                  <div className="flex items-center justify-between border-b border-slate-200/80 pb-3.5">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <h2 className="text-base font-extrabold text-slate-900 tracking-tight leading-tight">Corridor Intelligence Hub</h2>
                        <p className="text-[11px] text-slate-600 font-mono font-medium">East Coast India · Live Telemetry</p>
                      </div>
                    </div>
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-[10px] font-mono font-bold text-emerald-700 shadow-sm">
                  ...
                  <div className="space-y-2.5">
                    <div className="p-3 rounded-2xl bg-slate-50/90 border border-slate-200/90 flex items-center justify-between text-xs">
                      <div>
                        <p className="text-[10px] font-mono uppercase tracking-wider text-slate-500">Benchmark Dry Route</p>
                        <p className="font-bold text-slate-900 mt-0.5">Newcastle ➔ Paradip Port</p>
                      </div>
                      <div className="text-right">
                        <p className="font-mono font-extrabold text-sky-700 text-sm">$24.80 <span className="text-[10px] font-normal text-slate-500">/ MT</span></p>
                        <p className="text-[10px] font-mono text-emerald-600 font-semibold">P10: $22.40 | P90: $27.10</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-2.5">
                      <div className="p-3 rounded-2xl bg-slate-50/90 border border-slate-200/90">
                        <p className="text-[10px] font-mono uppercase tracking-wider text-slate-500">VLSFO Bunker Fuel</p>
                        <p className="text-sm font-bold font-mono text-slate-900 mt-0.5">$612.00</p>
                        <p className="text-[10px] text-teal-700 font-semibold font-mono">Singapore Hub · -1.4%</p>
                      </div>

                      <div className="p-3 rounded-2xl bg-slate-50/90 border border-slate-200/90">
                        <p className="text-[10px] font-mono uppercase tracking-wider text-slate-500">Malacca Strait Risk</p>
                        <p className="text-sm font-bold font-mono text-emerald-700 mt-0.5">1.02x Normal</p>
                        <p className="text-[10px] text-slate-500 font-mono">Zero Disruptions</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-200/80">
                    <p className="text-[10px] text-slate-500 font-mono font-bold mb-2 uppercase tracking-wider">Quick Intelligence Launchers:</p>
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        type="button"
                        onClick={() => handleNav('forecaster')}
                        className="p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white flex items-center gap-2 text-left transition-all shadow-sm active:scale-95 group"
                      >
                        <LineChart className="w-4 h-4 text-sky-400 group-hover:scale-110 transition-transform" />
                        <div>
                          <p className="text-[11px] font-bold">Forecaster</p>
                          <p className="text-[9px] text-slate-300 font-mono">ML Rate Curve</p>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        className="p-2.5 rounded-xl bg-sky-700 hover:bg-sky-800 text-white flex items-center gap-2 text-left transition-all shadow-sm active:scale-95 group"
                      >
                        <Ship className="w-4 h-4 text-emerald-300 group-hover:scale-110 transition-transform" />
                        <div>
                          <p className="text-[11px] font-bold">Optimizer</p>
                          <p className="text-[9px] text-sky-200 font-mono">Vessel Fixture</p>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        className="p-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-900 border border-slate-200 flex items-center gap-2 text-left transition-all active:scale-95 group"
                      >
                        <Radar className="w-4 h-4 text-rose-600 group-hover:scale-110 transition-transform" />
                        <div>
                          <p className="text-[11px] font-bold">Risk Radar</p>
                          <p className="text-[9px] text-slate-500 font-mono">Chokepoint NLP</p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-[11px] font-bold">East Coast Ports</p>
                          <p className="text-[9px] text-slate-500 font-mono">Drafts & Berths</p>
                        </div>
                      </button>
                    </div>
                  </div>
