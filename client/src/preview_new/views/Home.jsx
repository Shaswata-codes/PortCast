        ...
        <section className="pt-2">
          <ScrollReveal>
            <div className="max-w-3xl space-y-8">
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.05] [text-shadow:0_2px_18px_rgba(255,255,255,0.78),0_1px_3px_rgba(255,255,255,0.92)]">
                Predict Freight. <br />
              ...
              <div className="mt-3 inline-block rounded-xl bg-white/72 backdrop-blur-md border border-white/80 shadow-sm px-3 py-2">
              <p className="text-lg sm:text-xl text-slate-800 leading-relaxed max-w-2xl font-normal">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <button
                  ...
                  className="px-8 py-4 rounded-xl bg-slate-900/90 hover:bg-slate-900 text-white font-semibold text-sm transition-all shadow-xl hover:shadow-2xl flex items-center gap-2.5 active:scale-95 group backdrop-blur-md"
                >
                ...
                <button
                  ...
                  className={`px-8 py-4 rounded-xl ${glassCard} text-slate-900 font-bold text-sm flex items-center gap-2`}
                >
              ...
              <div className="grid grid-cols-3 gap-6 pt-10 mt-6 border-t border-white/50">
                <div className={`p-6 rounded-2xl ${glassCard}`}>
                  <p className="text-2xl lg:text-3xl font-extrabold text-sky-950 font-mono">0.9997</p>
                  <p className="text-xs text-slate-700 font-semibold mt-1">LightGBM Model R²</p>
                </div>
                <div className={`p-6 rounded-2xl ${glassCard}`}>
                  <p className="text-2xl lg:text-3xl font-extrabold text-teal-950 font-mono">14.2%</p>
                  <p className="text-xs text-slate-700 font-semibold mt-1">Avg Charter Savings</p>
                </div>
                <div className={`p-6 rounded-2xl ${glassCard}`}>
                  <p className="text-2xl lg:text-3xl font-extrabold text-slate-950 font-mono">30 Days</p>
                  <p className="text-xs text-slate-700 font-semibold mt-1">Predictive Horizon</p>
                </div>
              </div>
            </div>
          </ScrollReveal>
